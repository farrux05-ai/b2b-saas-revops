  ...
  create view "revops_analytics"."marts_int"."int_contacts__dbt_tmp" as (
    with contacts as (
    select * from "revops_analytics"."marts_staging"."stg_contacts"
...
campaigns as (
    select * from "revops_analytics"."marts_staging"."stg_campaigns"
)
